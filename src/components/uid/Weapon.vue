<template>
    <div :class="activeTab ? 'card-side flex items-center space-x-4 p-2':'rounded-lg bg-gray-900 bg-opacity-30 w-[440px] h-[120px] card-side flex items-center space-x-4 p-2'">
