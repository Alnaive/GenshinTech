...
<div class="flex items-center gap-2">
    <img src="/images/svg/FIGHT_PROP_CRITICAL.svg" class="w-8 h-7">
...
<div class="flex items-center gap-2" v-if="sessionData.fightPropMap[26] > 0">
    <img src="/images/attribute/Icon_Attribute_Healing.png" class="w-8 h-8">
...
<div class="flex items-center gap-2" v-if="charData.element == 'Grass' && sessionData.fightPropMap[43] > 0">
    <img src="/images/attribute/Dendro.png" class="w-8 h-8">
