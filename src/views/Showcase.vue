...
<div class="vld-parent">
   ...
   <div class="relative overflow-x-auto md:overflow-hidden rounded-lg mt-2" v-if="showBuild && showChar">
      <div class="flex flex-row w-[1275px] h-[550px] " >
            <div  v-for="dataVal in builds" :key="dataVal">
            <div class=" absolute z-30" v-for="build in dataVal" :key="build">
                        ...
                        <div class="flex flex-nowrap " >
                            <div class="flex flex-nowrap ">
                                <div class="card rounded-none w-[414px] h-[550px]" style="">
                                    ...
                                    <div class="flex items-center space-x-1 absolute left-3 top-12" v-if="build.friendship">
        ...
        <video autoplay loop muted class="object-cover w-[1300px] z-0 md:absolute md:w-none" :key="backgroundVid">
